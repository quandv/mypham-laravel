                        ...
                        <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
                            <div class="items-cart-inner">
                                ...
                                <div class="basket-item-count">
                                    @if(isset($cart) && isset($count))
                                        <span class="count" id="cart-count">{{$count}}</span>
                                    @else
                                ...
                                <div class="total-price-basket">
                                    ...
                                    <!-- <span class="total-price">
                                        <span class="sign"></span><span class="value cart-sum">0</span>
                                    </span> -->
                                </div>
                            ...
                            <li>
                                        ...
                                        @foreach($cart as $cartItem)
                                            <div class="cart-item product-summary">
                                                <div class="row">
                                                    <div class="col-xs-4">
                                                        <div class="image">
                                                            <a href="detail.html"><img src="/uploads/product/{{ $cartItem->options['img'] }}" alt=""></a>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-7">
                                                        <h3 class="name"><a href="index.php?page-detail">{{ $cartItem->name }}</a></h3>
                                                        <div class="price">{{ number_format($cartItem->price, 0, ',', '.') }} X {{ $cartItem->qty }}</div>
                                                    </div>
                                                    <div class="col-xs-1 action">
                                                        <a href="javascript:del_item_cart('{{ $cartItem->rowId }}');"><i class="fa fa-trash"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                ...
                                <div class="clearfix cart-total">
                                    <div class="pull-right">
                                        <span class="text">Tổng:</span><span class='price cart-sum'>@if(isset($subtotal)) {{$subtotal}} @else 0 @endif</span>
                                    </div>
                                    <div class="clearfix"></div>
                                        
                                    <a href="/gio-hang" class="btn btn-upper btn-primary btn-block m-t-20">Đặt hàng</a> 
                                </div><!-- /.cart-total-->
                                            ...
                                            <div class="yamm-content ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image">
                                                        <img class="img-responsive" src="/images/banners/top-menu-banner.jpg" alt="">
                                                    </div><!-- /.yamm-content -->   
