@extends('backend.layouts.master', ['page_title' => 'Thống kê hàng nhập theo năm'])
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-body">                
                    <div class="row">
                        <div class="col-sm-12">
                          <form class="form-inline" action="{!! route('admin.bill.statisticYear') !!}" method="get">                            
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="alert alert-success" role="alert">Thống kê năm <strong>"{{$year}}"</strong></div>
                      </div>
                    </div>
