    ...
    @if(count($errors) > 0)
      ...
      @endif
        <div class="box box-solid">
            ...
            <form role="form" id="addRoomForm" method="post" action="{!! route('admin.room.store') !!}" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                        <label class="control-label">Tên room <span class="required">*</span></label>
                        <div>
                            <input class="form-control" name="room_name" placeholder="Nhập tên room" type="text" value="{!! old('room_name') !!}">
                         </div>
                    </div>
                    <div class="form-group col-md-7 no-padding itemIP" style="overflow:hidden;">
                          @if(old('room_ip'))
                            @foreach(old('room_ip') as $key => $item)
                              @if($key==0)
                          ...
                          @else
                            <div class="inputIP col-md-12 no-padding">
                              <div class="col-xs-10 col-sm-10 col-md-10 no-padding">
                                <label class="control-label">IP <span class="required">*</span></label>
                                <div>
                                    <input class="form-control marginBot5" name="room_ip[]" placeholder="Nhập IP room" type="text" value="">
                                 </div>
                              </div>
                              <div class="col-xs-2 col-sm-2 col-md-2">&nbsp;</div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="pull-right">
                                <div class="input-group">
                                      <input class="form-control borderRad3" name="stxt" placeholder="Nhập tên room hoặc room ip" type="text" value="" style="width:250px">
