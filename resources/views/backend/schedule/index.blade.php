      ...
      @endif
        <div class="box box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Thêm mới ca</h3>
            </div> 
            <form role="form" method="post" action="{!! route('admin.schedule.store') !!}">
                <div class="box-body">
                    <div class="form-group ">
                        ...
                        <div>
                            <input class="form-control" id="schedule_name" name="schedule_name" placeholder="Nhập tên ca..." type="text" value="{!! old('schedule_name')!!}">
                         </div>
                    </div>
                    <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6 sm-right0" style="padding-left:0;">
                        ...
                        <div>
                            <select class="form-control" id="schedule_parent" name="time_start">
                                ...
                                <option value="{{$timeInADay[$key]}}">{{$value}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
