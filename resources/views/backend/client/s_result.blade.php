      ...
      @endif
        <div class="box box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Thêm mới Client</h3>
            </div> 
            <form role="form" id="post_category_add_form" method="post" action="{!! route('admin.client.store') !!}" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group ">
                        <label class="control-label">Tên máy <span class="required">*</span></label>
                        <div>
                            <input class="form-control" id="post_client_name_" name="client_name" placeholder="Nhập tên máy..." type="text" value="{!! old('client_name')!!}">
                         </div>
                    </div>
                    <div class="form-group ">
                        <label class="control-label">IP <span class="required">*</span></label>
                        <div>
                            <input class="form-control" id="post_client_ip_" name="client_ip" placeholder="Nhập IP máy..." type="text" value="{!! old('client_ip')!!}">
                         </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                        <label class="control-label">Cấu hình giao tiếp</label>
                        <div>
                            <input type="checkbox" name="chat_type" value="1" id="chat_type"> <label for="chat_type"  style="font-weight: 100">Mục giao tiếp quản trị</label>
                         </div>
                    </div>
                </div>
    ...
    <div class="col-xs-12 col-lg-7">
        <div class="box box-primary">
            <div class="box-body">
                        ...
                        <div class="col-sm-6">
                            <div class="pull-right">
                                <div class="input-group">
                                      <input class="form-control borderRad3" id=""  name="stxt" placeholder="Nhập tên máy hoặc IP" type="text" value="">
                ...
                <div>
                  @if ($stxt)
                    <div class="alert alert-success" role="alert">Kết quả tìm kiếm với từ khóa "{{$stxt}}"</div>
                  @endif
                </div>
                ...
                <div class="box-footer clearfix" id="pagination-link">
                  {{$clients->appends(Request::only('stxt'))->links()}}
                </div>
            </div>
            <!-- /.box-body -->
        </div>
