...
@section ('title','Lịch sử sản phẩm')
@section('content')
            ...
            <div class="box-header with-border">
              <!-- <div class="">
                ...
                <form class="form-inline" action="" method="get">
                  ...
                  <div class="form-group">
                    <input type="text" name="search_item" class="form-control borderRad3 marginBot5 width100"  placeholder="Tên sản phẩm,mã sản phẩm" value="@if(!empty(Request::input('search_item'))){!! Request::input('search_item') !!}@endif" style="width:250px">
                  </div>
                  <div class="form-group">
