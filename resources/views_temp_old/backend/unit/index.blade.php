            ...
            <form role="form" method="post" action="{!! route('unit.store') !!}">
                <div class="box-body">
                    <div class="form-group ">
                        ...
                        <div>
                            <input class="form-control" id="dv_name" name="dv_name" placeholder="Tên đơn vị" type="text" value="{!! old('dv_name')!!}">
                         </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div>
                            <textarea class="form-control" id="dv_description_" name="dv_desc" rows="7" placeholder="Mô tả">{!! old('category_description')!!}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="radio-inline">
                        <input type="radio" name="dv_status" value="1" checked> Hiện
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="dv_status" value="0"> Ẩn
                      </label>
                    </div>
                </div>
