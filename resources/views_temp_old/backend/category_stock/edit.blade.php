      ...
      @endif
        <div class="box box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Sửa Loại hàng nhập</h3>
            </div> 
            <form role="form" method="post" id="" action="{!! route('category_stock.update', ['id' => $details->id]) !!}" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group ">
                        <label for="post_name_" class="control-label">Loại hàng nhập <span class="red-star">*</span></label>
                        <div>
                            <input class="form-control" id="post_name_" name="name" placeholder="Loại hàng nhập" type="text" value="{!! $details->name !!}">
                         </div>
                    </div>
                      ...
                      @if(!empty($unit))
                        @foreach($unit as $dv)
                          <label class="radio-inline">
                            <input type="radio" name="unit" value="{!! $dv->dv_id !!}" @if( $dv->dv_id == $details->unit_id ) checked @endif> {!! $dv->dv_name !!}
                          </label>
                        @endforeach
                      @endif
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div>
                            <textarea class="form-control" id="description_" name="desc" rows="7" placeholder="Mô tả">{!! $details->desc !!}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="radio-inline">
                        <input type="radio" name="status" value="1" @if( $details->status == 1 ) checked @endif > Hiện
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="status" value="0"@if( $details->status == 0 ) checked @endif > Ẩn
                      </label>
                    </div>
