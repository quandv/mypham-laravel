@extends('backend.layouts.master', ['page_title' => 'Báo cáo theo tháng'])
@section ('title','Báo cáo theo tháng')
@section('content')
          ...
          <div class="box">
            <div class="box-header">
              <div class="col-xs-12 col-md-4">
                <form class="form-inline" action="{{ route('admin.report.month') }}" method="get">
            ...
            <div class="box-body table-responsive no-padding">             
              <div class="alert alert-success" role="alert">Danh sách đơn hàng trong tháng: {{$month}}</div>              
              <table class="table table-hover" id="order-table">
                ...
                <tr>                  
                  ...
                  <th><span class="required">*</span>Tổng cộng(hoàn thành)</th>
                  ...
                  @if(!empty($data) && $status)
                    ...
                    <tr>
                    	...
                    	@foreach($data as $key => $value)							
                          ...
                          <td>{{number_format((float)($value->sumFinishPrice - (isset($taikhoan[$i]) ? $taikhoan[$i] : 0) - (isset($combo[$i]) ? $combo[$i] : 0)), 0, ',', '.')}}</td>
          								<td>{{number_format($value->sumTotal, 0, ',', '.')}}</td>
          								<td><a class="btn-day-details" href="{{ route('admin.report.reportday', ['day' => $i.'-'.$month.'-'.$year]) }}">Chi tiết <i class="glyphicon glyphicon-chevron-right"></i></a></td>          							
          							@endif
                    	@endforeach
                    </tr>
                    @endfor
