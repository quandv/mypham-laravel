...
@section ('title','Báo cáo theo năm')
@section('content')
                    ...
                    <tr>
                      ...
                      @foreach($data as $key => $value)                        
                        @if( $i == $value->month )
                          ...
                          <td>
                            {{number_format((float)($value->sumFinishPrice - (isset($taikhoan[$i]) ? $taikhoan[$i] : 0) - (isset($combo[$i]) ? $combo[$i] : 0)), 0, ',', '.')}}
                            <!-- <p>Tài khoản: {{number_format((float)(isset($taikhoan[$i]) ? $taikhoan[$i] : 0), 0, ',', '.')}}</p>
                            <p>Combo: {{number_format((float)(isset($combo[$i]) ? $combo[$i] : 0), 0, ',', '.')}}</p> -->
                          </td>
