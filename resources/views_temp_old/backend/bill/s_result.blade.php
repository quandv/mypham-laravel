          ...
          <div class="box box-primary">
            ...
            <div class="box-body">                
                    <div class="row">
                        ...
                        <div class="col-sm-12">                          
                          <form class="form-inline pull-right" action="{!! route('admin.bill.search') !!}" method="get">
                            ...
                            <div class="form-group">
                              <input class="form-control borderRad3 marginBot5" name="stxt" placeholder="ID, Mã hóa đơn, người nhập" type="text" value="@if(!empty(Request::input('stxt'))) {!!Request::input('stxt')!!} @endif" style="width:300px">
                            </div>
                ...
                <div>
                  @if ($stxt != '')
                    @if ($day != '')
                      <div class="alert alert-success" role="alert">Kết quả tìm kiếm với từ khóa <strong>"{{$stxt}}"</strong>  trong ngày <strong>"{{$day}}"</strong> </div>
                    @else
                      <div class="alert alert-success" role="alert">Kết quả tìm kiếm với từ khóa <strong>"{{$stxt}}"</strong></div>
                    @endif
                  @else
                    @if ($day != '')
                      <div class="alert alert-success" role="alert">Kết quả tìm kiếm trong ngày <strong>"{!! $day !!}"</strong></div>
                    @endif                
                  @endif
                </div>
                <div>
                ...
                <div class="box-footer clearfix" id="pagination-link">
                  {!! $listBill->appends(Request::only(['day', 'stxt']))->links() !!}
                </div>
            </div>
