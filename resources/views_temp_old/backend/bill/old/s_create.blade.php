      ...
      <div class="row">        
        <div class="col-xs-12 col-md-12 bill">
          <div class="box box-primary"> <!-- collapsed-box -->
            ...
            @endif
            <div class="box-body">
              <form class="form-inline" action="{!! route('admin.bill.savebill') !!}" method="post" >
                <div class="">
                  ...
                  @if(isset($content))
                    @foreach($content as $key => $item)
                      <div class="productStockItem">
                        ...
                        @if(old('productQuantity'))
                        @foreach(old('productQuantity') as $oldItem)
                        <div class="col-md-2 itemCss">
                          <span class="required"><strong>&nbsp;(*)&nbsp;</strong></span><input required type="text" class="form-control" placeholder="Lượng" name="productQuantity[]" value="{!! $oldItem !!}"  style="width:70%"><span>&nbsp;{!! $item->options['unit'] !!}</span>
                        </div>
                        @endforeach
                        @else
                        <div class="col-md-2 itemCss">
                          <span class="required"><strong>&nbsp;(*)&nbsp;</strong></span><input required type="text" class="form-control" placeholder="Lượng" name="productQuantity[]"  style="width:70%"><span>&nbsp;{!! $item->options['unit'] !!}</span>
                        </div>
                        @endif

                        @if(old('productPrice'))
                        @foreach(old('productPrice') as $oldItem)
                        <div class="col-md-2 itemCss">
                          <span class="required"><strong>&nbsp;(*)&nbsp;</strong></span><input required type="text" class="form-control" placeholder="Giá" name="productPrice[]" value="{!! $oldItem !!}" style="width:70%"><span>&nbsp;vnđ</span>
                        </div>
                        @endforeach
                        @else
                        <div class="col-md-2 itemCss">
                          <span class="required"><strong>&nbsp;(*)&nbsp;</strong></span><input required type="text" class="form-control" placeholder="Giá" name="productPrice[]" style="width:70%"><span>&nbsp;vnđ</span>
                        </div>
                        @endif

                        @if(old('productExpiry'))
                        @foreach(old('productExpiry') as $oldItem)
                        <div class="col-md-2 itemCss">
                          <input type="datetime" class="form-control datepicker" data-date-format="yyyy-mm-dd" placeholder="Hạn dùng" name="productExpiry[]" style="width:90%" value="{!! $oldItem !!}">
                        </div>
                        @endforeach
                        @else
                        <div class="col-md-2 itemCss">
                          <input type="datetime" class="form-control datepicker" data-date-format="yyyy-mm-dd" placeholder="Hạn dùng" name="productExpiry[]" style="width:90%">
                        </div>
                        @endif
            ...
            <div class="box-body">                
                    <div class="row">
                        <div class="col-sm-6">
                          ...
                          <div class="col-md-7">                          
                            <a href="{!! route('stock.create') !!}"><button type="button" class="btn btn-primary">Thêm mới</button></a>
                          </div>

                        </div>
                        <div class="col-sm-6">                          
                          <form class="form-inline pull-right" action="{!! route('admin.bill.search_create') !!}" method="get">
