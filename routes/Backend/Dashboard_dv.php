...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['namespace' => 'Product'],function(){
      Route::group(['as'=>'admin.'],function(){
        ...
        Route::get('product/sort', 'ProductController@sort')->name('admin.product.sort');
    ...
    Route::group(['namespace' => 'CategoryStock'],function(){
    ...
    Route::group(['namespace' => 'ProductStock'],function(){
